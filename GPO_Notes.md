...
## Overview
GPOs are complex objects containing files (SYSVOL), directory attributes, and security links. We migrate them using the native Group Policy Management Console (GPMC) APIs, wrapped in PowerShell.
